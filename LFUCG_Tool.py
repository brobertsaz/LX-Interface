...
class Choose_Import_Export(wx.Frame):
    ...
    def Menu102(self, event):
        ...
        info.Name = "LFUCG Interface Tool"
        info.Version = "1.0"
        info.Copyright = "(C) 2010 C2Logix"
        info.Description = wordwrap(
            "The \"LFUCG Interface\" tool is a software program created by C2Logix that can be used "
...
try:
    ...
    top = Choose_Import_Export(title = "LFUCG Interface Tool", cwd = os.getcwd(), **more_args)
    top.Show()
    app.MainLoop()
finally:
    del app
